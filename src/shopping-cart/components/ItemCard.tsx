...
import { addItemToCart, removeItemsFromCart } from "../actions/actions";
...
export const ItemCard = ({ product, quantity }: Props) => {
  ...
  return (
    <div className="flex items-center shadow rounded-lg w-full dark:bg-gray-800  border-gray-100 mt-2">
      {/* Product Image */}
      <div className="p-2">
        <Image
          width={200}
      ...
      <div className="flex p-5 items-center justify-center mr-2 gap-3">
        <button
          onClick={onAddToCart}
